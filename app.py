...
# ------------------------ Streamlit UI ------------------------
st.set_page_config(page_title="🔍 RAG QA: Gemini & FLAN-T5", layout="wide")
st.title("🧠 RAG-based QA: Choose Gemini or FLAN-T5")

# Model selection
model_choice = st.radio("Select model to use:", ["Gemini API", "FLAN-T5 Local Model"])
